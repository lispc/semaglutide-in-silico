#!/usr/bin/env python3
"""
Production MD for exp-F: 100 ns NPT at 310 K.
Restarts from equilibrated checkpoint.

Output:
  - md/rep1/prod.dcd (trajectory, 10 ps/frame)
  - md/rep1/prod.log (energy log, 10 ps)
  - md/rep1/prod_checkpoint.chk (restart, every 1 ns)
"""
import sys, os, time
import openmm as mm
...
CHK_IN = f"{EXP_F}/md/rep1/equil.chk"
OUT_DIR = f"{EXP_F}/md/rep1"
