...
# Read protein - remove LNK hydrogens and N-terminal H3 from GLY 101
protein_atoms = []
with open('protein.pdb') as f:
    for line in f:
        if line.startswith('ATOM') or line.startswith('HETATM'):
            ...
            # Skip N-terminal H3 from GLY 101 (chain P)
            if chain == 'P' and resnum == 101 and resname == 'GLY' and atomname in ['H1', 'H2', 'H3', 'HA2', 'HA3']:
                continue
...
print(f"Protein atoms (LNK H + GLY H3 stripped): {len(protein_atoms)}")
